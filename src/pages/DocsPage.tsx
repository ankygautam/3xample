...
export function DocsPage() {
  ...
  return (
    <article className="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-panel">
      <div className="border-b border-slate-200 px-5 py-7 sm:px-8 sm:py-10">
      ...
      <div className="px-5 py-7 sm:px-8 sm:py-10">
        <div className="space-y-10 sm:space-y-12">
          {page.sections.map((section) => (
            <section key={section.title} className="border-b border-slate-200 pb-8 last:border-b-0 last:pb-0 sm:pb-10">
              <h2 className="text-[1.8rem] font-semibold tracking-tight text-slate-950 sm:text-2xl">
                {section.title}
              </h2>

              {section.paragraphs ? (
                <div className="mt-4 space-y-4 text-base leading-7 text-slate-600 sm:text-[1.02rem] sm:leading-8">
              ...
              {section.bullets ? (
                <ul className="mt-5 space-y-3 text-base leading-7 text-slate-600 sm:text-[1.02rem] sm:leading-8">
              ...
              {section.code ? (
                <pre className="mt-6 overflow-x-auto rounded-[1.6rem] border border-slate-200 bg-slate-950 p-4 text-sm leading-7 text-slate-200 sm:p-5">
