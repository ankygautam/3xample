    ...
    <section className="rounded-[2rem] border border-slate-200 bg-white p-5 shadow-soft sm:p-6">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h2 className="mt-2 text-3xl font-semibold text-slate-950">{animationName}</h2>
        </div>
      ...
      <div className="mt-8 rounded-[2rem] border border-slate-200 bg-slate-50 p-4 sm:p-6">
        <div className="grid min-h-[420px] place-items-center rounded-[1.75rem] bg-[radial-gradient(circle_at_top,_rgba(59,130,246,0.16),_transparent_34%),linear-gradient(135deg,_rgba(255,255,255,0.98),_rgba(241,245,249,0.94))] p-6">
          <div
            key={previewKey}
            style={animationStyle}
            className="w-full max-w-md rounded-[1.75rem] border border-slate-200 bg-white p-7 shadow-soft"
          >
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="text-sm font-semibold text-blue-700">Preview card</p>
                <h3 className="mt-2 text-2xl font-semibold text-slate-950">3xample motion demo</h3>
              </div>
